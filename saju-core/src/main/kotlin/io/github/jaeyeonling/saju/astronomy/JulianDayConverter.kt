 ...
 *
 * **proleptic Gregorian** 으로 고정한다 — 사주 v1 입력 범위(1391년 이후)에서 안전하다.
 * 1582-10-15(그레고리력 개시) 이전 날짜는 율리우스력 분기 없이 외삽하므로, 그 이전 입력은
 * 역사적 율리우스력 날짜와 어긋날 수 있다(사주 실사용은 근현대가 대부분이라 무방).
 */
