...
class LunarSajuTest : StringSpec({

    "음력 입력 사주는 변환된 양력 입력과 동일하다" {
        ...
        fromLunar shouldBe fromSolar
    }

    "음력 설날 2023-1-1 은 양력 1월 하순이다" {
        // 2023 설날(음 1-1) = 양력 2023-01-22.
        val solar = LunarConverter.toSolar(2023, 1, 1, isLeapMonth = false, basis = CalendarBasis.KOREA)
        solar.year shouldBe 2023
        solar.month shouldBe 1
        solar.day shouldBe 22
    }
