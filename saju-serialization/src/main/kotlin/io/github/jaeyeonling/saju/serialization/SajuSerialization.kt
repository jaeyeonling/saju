...
public val sajuJson: Json = Json {
    prettyPrint = true
    encodeDefaults = true
}

public fun GanZhi.toDto(): GanZhiDto = GanZhiDto(
    name = koreanName,
    hanja = hanja,
    gan = gan.koreanName,
    ji = ji.koreanName,
...
public fun Cheongan.toDto(): CheonganDto = CheonganDto(
    name = koreanName,
    hanja = hanja,
...
public fun SajuChart.toDto(): SajuChartDto = SajuChartDto(
    year = year.toDto(),
    month = month.toDto(),
    day = day.toDto(),
    hour = hour.toDto(),
...
public fun SinStrength.toDto(): SinStrengthDto = SinStrengthDto(
    verdict = verdict.name,
    verdictKorean = verdict.koreanName,
    supportRatio = supportRatio,
)

public fun YongsinResult.toDto(): YongsinDto = YongsinDto(
    ohaeng = yongsin.koreanName,
    method = method.name,
    methodKorean = method.koreanName,
)

public fun GyeokgukResult.toDto(): GyeokgukDto = GyeokgukDto(
    type = type.name,
    typeKorean = type.koreanName,
    basis = basis,
)

public fun HapChungRelation.toDto(): HapChungDto = when (this) {
...
public fun InterpretationReport.toDto(): InterpretationReportDto = InterpretationReportDto(
